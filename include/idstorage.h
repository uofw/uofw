...
/* Offset into leaf [SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_3_UMD_1] at which region-code-info related data can be found. */
#define SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_3_UMD_1_OFFSET_REGION_CODES		0xB0
#define SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_3_UMD_1_OFFSET_REGION_CODES_SIZE	(4 * SCE_ID_STORAGE_LEAF_SIZE)
...
#define SCE_ID_STORAGE_LEAF_ID_UMD_COUNT							  ((SCE_ID_STORAGE_LEAF_ID_UMD_5 - SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_3_UMD_1) + 1)
