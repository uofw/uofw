...
s32 _sceChkregLookupConsoleIdCertificate(void)
{
    ...
    if (sceIdStorageLookup(SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_1, SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_1_OFFSET_CONSOLE_ID_CERTIFICATE_1, &g_ConsoleIdCertificate, KIRK_CERT_LEN) < SCE_ERROR_OK
        && sceIdStorageLookup(SCE_ID_STORAGE_LEAF_ID_BACKUP_CONSOLE_ID_OPEN_PSID_1, SCE_ID_STORAGE_LEAF_CONSOLE_ID_OPEN_PSID_1_OFFSET_CONSOLE_ID_CERTIFICATE_1, &g_ConsoleIdCertificate, KIRK_CERT_LEN) < SCE_ERROR_OK) // 0x000001B0 & 0x000001F0
    {
        return SCE_ERROR_NOT_FOUND;
    }
