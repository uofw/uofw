...
sub_00E0(void *arg0, void *arg1, arg2, void *arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11) // at 0x000000E0
{
    v1 = (u32)a3 < (u32)1;
    v0 = (u32)t1 < (u32)1;
    //sp = sp - 176;
    ...
    *(s32*)(sp + 80) = 0;
    ...
    if (v0 == 0)
        goto loc_00000858;
    t3 = 0x10000; // Data ref 0x00008EE8 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    a3 = 0;
    t0 = t3 - 28952; // Data ref 0x00008EE8 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    // 0190
    do {
	    v0 = s0 + a3;
	    a0 = *(u8*)(v0 + 0);
    ...
    *(s32*)(sp + 84) = v0;
    ...
    if (cond) {
    	...
    	v0 = t3 - 28952; // Data ref 0x00008EE8 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    	// 1884
    	v0 = *(u8*)(v0 + 212);
    	*(s32*)(sp + 80) = v0;
    	goto loc_00000240;
...
loc_00000240:		
    ...
    v1 = (u32)0 < (u32)a2;
    v0 = v0 & v1;
    a0 = t3 - 28952; // Data ref 0x00008EE8 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    if (v0 != 0) {
    	// 1838
    	*(s32*)(sp + 112) = t3; // Data ref 0x00BA001B
    	v0, v1 = sub_0000006C(...);
    	v1 = 1;
    	t0 = -305;
    	t3 = *(s32*)(sp + 112);
...
loc_00000388:		
    ...
    if (!cond) {
    	...
    	*(s32*)(v0 - 29248) = s0; // Data ref 0x00008DC0 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    	*(s32*)(s0 + 0) = v1;
    	if (s7 == 0) {
    		// 17C0
    		a0 = s0;
...
loc_000007D0:		
    ...
    if (s7 == 0) {
    	// 0D24
    	a0 = v1 - 28416; // Data ref 0x00009100 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    	a1 = 336;
    	a2 = a0;
    	a3 = 336;
    	t0 = 11; // Data ref 0x024D1AFD
    	v0, v1 = sceUtilsBufferCopyWithRange(...);
    	a0 = 0x10000; // Data ref 0x00009100 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    } else {
    	v0 = 0x10000; // Data ref 0x00009100 ... 0x00000000 0x00000000 0x00000000 0x00000000 
...
loc_00000858:
    v0 = 0x10000; // Data ref 0x00009038 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    a1 = v0 - 28616; // Data ref 0x00009038 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    a0 = 0;
    // 0860
    do {
    	v1 = a0 + a1;
...
loc_000017E0:		
    ...
    t0 = v1 - 28396; // Data ref 0x00009114 ... 0x00000000 0x00000000 0x00000000 0x00000000 
    a3 = 0;
    t1 = t0 - 20;
    a2 = a3 << 4;
    // 17F4
